...
function Navbar() {
    ...
    const downloadHandle = () => {
        ...
        link.click();
        window.open(
            "https://drive.google.com/file/d/1aNE00zT9O-_R6sS4oS9vz67eBycuJR6n/view?usp=drive_link",
            "_blank"
        );
    };
        ...
        <>
            <div id='nav-menu'>
                ...
                <div id="largeScreenNavbar">
                    <a href='#home'><h2>{"Sachin Semwal </>"}</h2></a>
                    ...
                    <div>
                        ...
                        <a href="https://github.com/SachinSemwal007" target="_blank" rel="noreferrer" className="nav-link github">
                            GitHub
                        </a>
                    </div>
                </div>
            ...
            </div >
            {
                burger ? (<div id='smallScreenDropDown' >
                    <div>
                        ...
                        <a href="https://github.com/SachinSemwal007" target="_blank" rel="noreferrer" className="nav-link github" style={{ margin: "auto", width: "100px" }}
